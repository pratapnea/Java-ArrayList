...
/** ArrayList example
 * @author Pratap Neaupane
 * Dated on 17th Feb 2020
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        boolean quit = false;
        int choice = 0;
        System.out.println("======= Welcome to Nepathya's Grocery Store! =======");
        printInstructions();
        while(!quit) {
    ...
    public static void addItem() {
        ...
        grocery.addGroceryList(scan.nextLine());
    }
    ...
    public static void modifyItem() {
        ...
        grocery.modifyGroceryList(itemNo-1, newItem);
    }
